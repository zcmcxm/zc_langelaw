...
export function AppFooter() {
  ...
  return (
    ...
    >
      <div className="container-md flex flex-col sm:flex-row justify-between items-center gap-10 sm:gap-3 mx-4">
        <p className="font-light text-sm sm:text-base text-primary">
